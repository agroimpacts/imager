...
url_planet_4bands <- read.csv('/Users/coloury/Downloads/url_planet_4bands.csv', as.is = TRUE)
string_format <- readtext('/Users/coloury/Downloads/cmd_format.rtf')
...
write.table(url_planet_4band, '/Users/coloury/url_planet_4bands_restore.txt', col.names = FALSE, row.names = FALSE, quote = FALSE)

increment <- nrow(url_planet_4bands_selected) /2
 
#write.csv(url_planet_4bands_selected, file = '/Users/coloury/Downloads/url_planet_4bands_selected.csv')
#write.table(url_planet_4bands_selected, '/Users/coloury/Downloads/url_planet_4bands_selected.txt', col.names = FALSE, row.names = FALSE, quote = FALSE)
t1<- as.data.frame(url_planet_4bands_selected[1:increment,])
write.table(t1, '/Users/coloury/url_planet_4bands_tie1.txt', col.names = FALSE, row.names = FALSE, quote = FALSE)
t2 <- as.data.frame(url_planet_4bands_selected[(increment+1):(increment*2),])
write.table(t2, '/Users/coloury/url_planet_4bands_tie2.txt', col.names = FALSE, row.names = FALSE, quote = FALSE)
t3 <- as.data.frame(url_planet_4bands_selected_udm[1:increment,])
write.table(t3, '/Users/coloury/url_planet_4bands_tie3.txt', col.names = FALSE, row.names = FALSE, quote = FALSE)
t4 <- as.data.frame(url_planet_4bands_selected_udm[(increment+1):(increment*2),])
write.table(t4, '/Users/coloury/url_planet_4bands_tie4.txt', col.names = FALSE, row.names = FALSE, quote = FALSE)
...
write.table(key, '/Users/coloury/Downloads/url_planet_4bands_selected_test.txt', col.names = FALSE, row.names = FALSE, quote = FALSE)


                     
cmd <- paste0('aws s3api restore-object --bucket activemapper --key ', key, '--restore-request Days=7,GlacierJobParameters={"Tier"="Bulk"}')
system(cmd)

aws s3api restore-object --bucket activemapper --key planet/analytic_sr_all/059c6c3e-7f51-43cf-9228-b7dcfdbcc2a0/1/files/PSScene4Band/20171231_105752_0f53/analytic_sr/20171231_105752_0f53_3B_AnalyticMS_SR.tif --restore-request '{"Days":7,"GlacierJobParameters":{"Tier":"Bulk"}}'