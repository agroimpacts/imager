...
url_planet_4bands <- read.csv('***REMOVED***/url_planet_4bands.csv', as.is = TRUE)
string_format <- readtext('***REMOVED***/cmd_format.rtf')
...
write.table(key, '***REMOVED***/url_planet_4bands_selected_test.txt', col.names = FALSE, row.names = FALSE, quote = FALSE)
