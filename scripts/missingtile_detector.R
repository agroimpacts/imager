...
# common_path <- "C:/Users/sye/Dropbox/MappingAfrica/TimeSeries"
# common_path <- "/home/su/Dropbox/MappingAfrica/TimeSeries"
common_path <- "/Users/coloury/Dropbox/MappingAfrica"
...
key.list <- get_bucket_df(bucket = 'activemapper', prefix = 'planet/composite_sr_buf_fix/GS', max = Inf)['Key']
...
key.list <- get_bucket_df(bucket = 'activemapper', prefix = 'planet/composite_sr_buf_fix/OS', max = Inf)['Key']
...
key.list.os <- get_bucket_df(bucket = 'activemapper', prefix = 'planet/composite_sr_buf/OS', max = Inf)['Key']
